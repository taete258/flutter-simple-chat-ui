...
import 'package:flutter_jobtopgun/listViewCard/listViewCard.dart';
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
            backgroundColor: Color.fromARGB(210, 133, 249, 212),
            title: Text(
              widget.title,
            ),
            centerTitle: true),
        body: Center(
          child: Column(
            ...
            children: <Widget>[Expanded(child: ListViewCardApp())],
          ),
        ),
